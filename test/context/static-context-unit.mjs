...
assert.match(STATIC_CONTEXT, /use relai_work plan as a concrete ordered checklist; update step states as work advances/i, 'multi-step tasks must maintain an explicit durable plan instead of relying on inferred activity');
