...
const TOOL_FIELDS = Object.freeze({
  ...
  [OP.PROCESS_START]: ['ok', 'work_id', 'processId', 'pid', 'workspace', 'workspaceId', 'label', 'kind', 'purpose', 'pty', 'columns', 'rows', 'metadataRevision', 'commandSummary', 'cwd', 'status', 'reused', 'queueWaitMs', 'readiness', 'lifecycle', 'originatingTaskId', 'workSessionId', 'startedAt', 'endedAt', 'exitCode', 'signal', 'stdoutBytes', 'stderrBytes', 'stdoutDroppedBytes', 'stderrDroppedBytes', 'stdoutRetainedFromOffset', 'stderrRetainedFromOffset', 'environmentKeys', 'stdoutTail', 'stderrTail', 'readiness', 'error'],
